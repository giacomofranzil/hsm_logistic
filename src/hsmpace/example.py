...
# (pass_no, stand, verso, h_in, h_out, w_in, w_out, v_exit, reversing_delay)
_PASSES = [
    (1, "R1", FWD, 220.0, 175.0, 1250.0, 1255.0, 2.50, 0.0),
    (2, "R1", REV, 175.0, 135.0, 1255.0, 1260.0, 3.00, 6.0),
    (3, "R1", FWD, 135.0, 105.0, 1260.0, 1265.0, 3.50, 6.0),
    (4, "R2", FWD, 105.0, 75.0, 1265.0, 1268.0, 3.50, 0.0),
    (5, "R2", REV, 75.0, 52.0, 1268.0, 1270.0, 4.00, 6.0),
    (6, "R2", FWD, 52.0, 38.0, 1270.0, 1272.0, 4.50, 6.0),
    (7, "F1", FWD, 38.0, 22.0, 1272.0, 1272.0, 1.70, 0.0),
    (8, "F2", FWD, 22.0, 13.2, 1272.0, 1272.0, 2.84, 0.0),
    (9, "F3", FWD, 13.2, 8.6, 1272.0, 1272.0, 4.36, 0.0),
    (10, "F4", FWD, 8.6, 6.0, 1272.0, 1272.0, 6.25, 0.0),
    (11, "F5", FWD, 6.0, 4.5, 1272.0, 1272.0, 8.33, 0.0),
    (12, "F6", FWD, 4.5, 3.6, 1272.0, 1272.0, 10.42, 0.0),
    (13, "F7", FWD, 3.6, 3.0, 1272.0, 1272.0, 12.50, 0.0),
]


def example_case() -> Case:
    passes = []
    for pass_no, stand, direction, h_in, h_out, w_in, w_out, v_exit, delay in _PASSES:
        passes.append(
            RollingPass(
                product_id="P1",
                pass_no=pass_no,
